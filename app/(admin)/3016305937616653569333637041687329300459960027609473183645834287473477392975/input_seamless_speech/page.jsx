...
const INPUTCODE_TYPE = "seamless-speech-mismatch"
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <h1 className="mt-2 text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Seamless Speech Mismatch Input Codes</h1>
      <p className="text-sm text-gray-500">Input codes for the mismatch side of Seamless Speech Mismatch studies. Origin-side codes are managed in Seamless Input Codes.</p>

      <div className="mt-3 text-center flex gap-2 justify-center items-center">
        <button
          className="cursor-pointer text-sm py-2 px-4 border border-blue-500 bg-blue-500 text-white max-md:hidden whitespace-nowrap subpixel-antialiased hover:underline rounded-md transition-all"
