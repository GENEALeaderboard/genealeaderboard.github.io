...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <h1 className="mt-2 text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Seamless Semantic Mismatch Input Codes</h1>
      <p className="text-sm text-gray-500">Input codes for Seamless Semantic Mismatch studies (origin + mismatch pools).</p>
