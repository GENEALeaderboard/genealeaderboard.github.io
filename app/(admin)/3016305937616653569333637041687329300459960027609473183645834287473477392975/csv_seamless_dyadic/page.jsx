...
import { generateSeamlessDyadicMismatch } from "../csv/generateSeamlessDyadicMismatch"
...
export default function Page() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const pageList = generateSeamlessDyadicMismatch(studiesCSV, videoOrigin, videoMismatch, studiesID, studyConfig, attentionCheckList)
