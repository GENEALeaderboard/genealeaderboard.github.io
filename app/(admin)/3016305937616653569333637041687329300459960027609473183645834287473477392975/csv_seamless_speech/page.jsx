...
export default function Page() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const pageList = generateSeamlessSpeechMismatch(studiesCSV, videoOrigin, videoMismatch, studiesID, studyConfig, attentionCheckList, pairs, includeAttentionChecks)
