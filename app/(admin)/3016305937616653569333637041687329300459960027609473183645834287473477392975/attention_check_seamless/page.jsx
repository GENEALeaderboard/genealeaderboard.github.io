  ...
  return (
    <>
      <h2 className="font-semibold tracking-tight text-slate-900 dark:text-slate-100 mt-10 border-b pb-1 text-3xl border-neutral-200/70 contrast-more:border-neutral-400 dark:border-primary-100/10 contrast-more:dark:border-neutral-400">
        Seamless Attention Check Videos
      </h2>
      ...
      <div className="nextra-code relative mt-6 first:mt-0">
        ...
        >
          <code className="nextra-code" dir="ltr">
            <span><span>/videos/attentioncheck/{CATEGORY}/&lt;1_LeftClearlyBetter_Audio_Unmuted&gt;.mp4</span></span>
            <span><span>/videos/attentioncheck/{CATEGORY}/&lt;1_Reference&gt;.mp4</span></span>
            <span><span>/videos/attentioncheck/{CATEGORY}/&lt;2_LeftSlightlyBetter_Text_Muted&gt;.mp4</span></span>
            <span><span>/videos/attentioncheck/{CATEGORY}/&lt;2_Reference&gt;.mp4</span></span>
          </code>
        </pre>
      </div>
