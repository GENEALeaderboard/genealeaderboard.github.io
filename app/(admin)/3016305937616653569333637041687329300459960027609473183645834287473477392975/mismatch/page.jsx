...
import UploadMismatch from "./UploadMismatch"
...
export default function Page() {
  return (
    <>
      ...
      <h4 className="font-semibold tracking-tight text-slate-900 dark:text-slate-100 mt-8 text-xl">Mismatch structure</h4>
      <div className="nextra-code relative mt-6 first:mt-0">
        ...
        >
          <code className="nextra-code" dir="ltr">
            ...
            <span>
              <span>/videos/mismatch/&lt;video_segment_name&gt;.mp4</span>
            </span>
          </code>
        </pre>
      </div>
      <h4 className="font-semibold tracking-tight text-slate-900 dark:text-slate-100 mt-8 text-xl">Upload Mismatch Video</h4>
