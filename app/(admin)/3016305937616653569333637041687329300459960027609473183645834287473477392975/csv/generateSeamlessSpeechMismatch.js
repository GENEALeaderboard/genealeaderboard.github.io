// TODO: confirm the attention-check filter for Seamless Speech Mismatch.
// Currently mirrors generateMismatchSpeech.js (Audio|Text + Unmuted).
import { buildPairMap, normalizeCode } from "./pairsLookup"

export function generateSeamlessSpeechMismatch(studiesCSV, videoOrigins, videoMismatch, studiesID, studyConfig, attentionCheckList, pairs, includeAttentionChecks = true) {
